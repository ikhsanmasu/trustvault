        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-primary px-6 py-16 sm:px-12 sm:py-20 lg:px-16">
            ...
            <div className="relative text-center max-w-2xl mx-auto">
              <h2 className="font-display text-3xl sm:text-4xl lg:text-[2.9rem] font-semibold tracking-tight text-primary-foreground leading-[1.12] text-balance">
                The next revision is already on its way.{" "}
                <em className="text-secondary">Know if it matters.</em>
              </h2>
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 justify-center">
                <Link
                  ...
                  className={cn(
                    ...
                    "w-full sm:w-auto rounded-full bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold shadow-xl shadow-secondary/15 h-12 px-8 text-base",
                  )}
                >
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    "w-full sm:w-auto rounded-full bg-primary-foreground/10 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/20 hover:border-primary-foreground/50 h-12 px-8 text-base font-medium",
                  )}
                >
                  Sign in
                </Link>

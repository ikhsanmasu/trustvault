    ...
    <section id="pricing" className="relative bg-muted/30 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <SectionHeader
            eyebrow="Pricing"
            title="Start free. Upgrade when your team does."
            description="Every plan runs the same verification pipeline — hashing first, AI judgment second. No credit card required to start."
          />
        </Reveal>
            ...
            <Reveal key={plan.name} delay={index * 90} className="h-full">
              ...
              >
                ...
                <div className="mb-6 flex items-baseline gap-1.5">
                  <span className="font-display text-[2.75rem] font-semibold tracking-tight text-foreground leading-none">
                    {plan.price}
                  </span>
                  {plan.period && (
                ...
                <Link
                  href={plan.href}
                  className={cn(
                    "w-full text-center rounded-full px-4 py-2.5 text-sm font-semibold transition-all",
                    plan.highlighted

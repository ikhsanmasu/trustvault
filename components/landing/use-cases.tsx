const useCases = [
  ...
  },
  {
    title: "Finance & Audit",
    description:
      "Expense reports, invoices, and audit confirmations change hands constantly. Verify that the version being approved is the version that was reviewed -- and know when a change is material.",
    icon: (
      <svg className="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">

-- TrustVault P1 — local dev/demo seed data
-- Inserts 3 sample document rows for convenient local development and testing.

INSERT INTO public.documents (id, name, storage_path, binary_hash, text_hash, extracted_text, file_size_bytes)
VALUES
(
  'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  'Sample Contract v1',
  'uploads/2026/a1b2c3d4-e5f6-7890-abcd-ef1234567890.pdf',
...
(
  ...
  'uploads/2026/b2c3d4e5-f6a7-8901-bcde-f12345678901.pdf',
...
(
  ...
  'uploads/2026/c3d4e5f6-a7b8-9012-cdef-123456789012.pdf',
